          ...
          <div className="flex items-center justify-between bg-white p-4 rounded-lg shadow-md mb-4">
            <div className="flex items-center space-x-4">
              <div className="w-24 h-24 bg-orange-200 rounded">
                <Image src="/01.jpg" alt="Library Stool Chair" width={150} height={150} />
              </div>
              <div>
            ...
            <div className="flex gap-3">
              ...
              <p className="text-[16px] font-normal text-[#111111]">$19.99</p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between bg-white p-4 rounded-lg shadow-md">
            <div className="flex items-center space-x-4">
              <div className="w-24 h-24 bg-gray-300 rounded">
                <Image src="/02.jpg" alt="Library Stool Chair" width={150} height={150} />
              </div>
              <div>
                <h3 className="text-[16px] font-normal text-[#272343] mb-3">
                  Library Stool Chair
        ...
        <div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="flex justify-between mb-4">
              ...
              <p className="text-lg font-semibold">$39.98</p>
            </div>
            <div className="flex justify-between mb-4">
              <p className="text-lg">Estimated Delivery & Handling</p>
              <p className="text-lg font-semibold text-green-500">$10</p>
            </div>
            <hr className="mb-4" />
            <div className="flex justify-between mb-6">
              <p className="text-xl font-bold">Total</p>
              <p className="text-xl font-bold">$49.98</p>
            </div>
