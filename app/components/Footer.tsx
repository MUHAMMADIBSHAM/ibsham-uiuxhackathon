      ...
      <div className="mx-auto py-12">
        <div className="flex flex-wrap justify-between gap-8">
          ...
          <div className="w-full md:w-1/4 lg:w-[424px]">
            ...
            <p className="mt-4 text-gray-500">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ullam atque laboriosam sequi quisquam fug
              it asperiores. Consequatur sapiente debitis optio fuga necessitatibus d
              istinctio pariatur, beatae facilis hic quisquam eos commodi dolores.
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center flex-wrap text-[#9A9CAA] border-t pt-8">
          <p>
            © 2024 - Ecommerce - Designed & Developed by{" "}
            <a href="#" className="text-[#272343] hover:underline">
              Muhammad Ibsham Shahid
            </a>
          </p>
