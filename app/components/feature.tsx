...
export default function Feature() {
  ...
  const FeatureImage = [
    '/featuredata/white-chair.png',
    '/featuredata/brownsofachair.png',
            ...
            <div key={i} className="flex flex-col items-center bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
              ...
              <div className="flex justify-between w-full px-4 py-2">
                <div className="flex flex-col items-start">
                  <h2 className="font-medium text-lg mb-1">Library Stool Chair</h2>
                  <span className="text-black text-lg font-bold">$19.99</span>
                </div>
